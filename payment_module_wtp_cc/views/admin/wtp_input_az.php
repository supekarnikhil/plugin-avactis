...
//------------------------------------------------
    ...
    function CheckoutPaymentModuleWtpInputAZ()
    {
		...
		$this->mTmplFiller = new TmplFiller(dirname(__FILE__).'/templates/');
    ...
    function outputErrors()
    {
        ...
        foreach ($this->ErrorsArray as $error)
        {
            ...
            $result .= $this->mTmplFiller->fill("list/", "error.tpl.html", array());
        }
        return $result;
    }
    ...
    function outputStatus()
    {
        ...
        $retval.= $this->mTmplFiller->fill("list/", "status.tpl.html", array());
        return $retval;
    }
    ...
    function output()
    {
        ...
        return $output. $this->mTmplFiller->fill("list/", "list.tpl.html", array());
    }
